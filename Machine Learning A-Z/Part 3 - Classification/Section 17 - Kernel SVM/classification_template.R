...
setwd('C:\\Users\\toshiba\\Desktop\\Machine Learning A-Z\\Part 3 - Classification\\Section 17 - Kernel SVM')
...
library(e1071) # SVM'in popüler paketi
classifier = svm(formula = SatinAldiMi ~ .,
                 data = training_set,
